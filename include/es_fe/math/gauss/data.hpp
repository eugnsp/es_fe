...
struct Gauss_data<0>
{
	static constexpr auto points = es_util::make_array(Gauss_point{1, 0});
};
...
struct Gauss_data<2>
{
	static constexpr auto points =
		es_util::make_array(Gauss_point{.5, -es_util::math::sqrt_three / 3},
			Gauss_point{.5, es_util::math::sqrt_three / 3});
};

template<>
struct Gauss_data<3>
{
	static constexpr auto points = es_util::make_array(Gauss_point{5 / 18, -7.745966692414834e-1},
...
{
	static constexpr auto points =
		es_util::make_array(Gauss_point{1.7392742256872693e-1, -8.6113631159405302e-1},
...
{
	static constexpr auto points =
		es_util::make_array(Gauss_point{1.1846344252809454e-1, -9.0617984593866396e-1},
