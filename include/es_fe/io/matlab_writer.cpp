...
// namespace fe
// {
// void MATFileOutput::writeDataOnCells(const std::string& name, const LA::VectorX<double>& data, double scale)
// {
...
// }
// 
// void MATFileOutput::_writeDataOnEdges(const std::string& name, const LA::VectorX<double>& data, double scale)
// {
...
// template<class MESH>
// FeMATFileOutput<MESH>::FeMATFileOutput(const std::string& _name, const MESH& _mesh, double _meshLengthScale /* = 1 */)
// 	: FeFileOutput(_mesh, _meshLengthScale), file(_name)
// {
// }
// 
...
// 
// template<class MESH>
// void FeMATFileOutput<MESH>::PutScalarDataOnNodes(const std::string& name, const Math::LA::VectorX<double>& data)
// {
...
// 
// template<class MESH>
// void FeMATFileOutput<MESH>::PutScalarDataOnNodes(const std::string& name, Math::LA::VectorX<double> data, double scale)
// {
// 	assert(data.size() == mesh.n_vertices());
// 
// 	data *= (1 / scale);
...
// 
// template<class MESH>
// void FeMATFileOutput<MESH>::PutScalarDataOnElements(const std::string& name, const Math::LA::VectorX<double>& data, double scale /* = 1 */)
// {
...
// 
// //template<class MESH>
// //void FeMATFileOutput<MESH>::PutScalarDataOnNodes(const std::string& _name, const FeLinearSolutionView<MESH, double>& _data, double _scale /* = 1 */)
// //{
...
// 
// //template<class MESH>
// //void FeMATFileOutput<MESH>::PutScalarDataOnNodes(const std::string& _name, const DataOnNodesViewType<double>& _data, double _scale /* = 1 */)
// //{
// //	if (!IsInitialized())
// //		Init();
// //
...
// //}
// 
// //void FeMATFileOutput::PutScalarDataOnNodes(const std::string& _name, const FeEigenSolutionView<double>& _data, double _scale /* = 1 */)
// //{
...
// //
// //	for (unsigned int eigenPairIndex = 0; eigenPairIndex < _data.GetNumberOfEigenValues(); ++eigenPairIndex)
// //	{
...
// //}
// //
// //void FeMATFileOutput::_PutScalarDataOnNodes(const std::string& _name, const FeEigenSolutionView<double>& _data, double _scale /* = 1 */)
// //{
// //	assert(IsInitialized());
// //	//assert(_data.GetSize() == mesh.n_vertices());
// //
...
// //	{
// //		for (unsigned int i = 0; i < mesh.n_vertices(); ++i)
// //			dens[i] += _data.GetEigenvector(eigenPairIndex, i) * _data.GetEigenvector(eigenPairIndex, i) *
// //			SpecialFunctions::FermiDiracMinusHalf(-_data.GetEigenvalue(eigenPairIndex) / .00095043);
// //	}
// //
