...
// 		class EdgeChainVertexIterator : public Internal::IteratorBase<2, Vertex_tag, std::forward_iterator_tag>
// 		{
// 		public:
...
class Edge_chain_edge_iterator : public internal::Iterator_base<Edge_tag, Mesh2, std::forward_iterator_tag>
{
private:
	using Edge_list = std::vector<Index>;

public:
	Edge_chain_edge_iterator(const Mesh2& mesh, Edge_list::const_iterator it, Edge_list::const_iterator itEnd)
