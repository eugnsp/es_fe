...
#include <es_fe/math/dunavant/points_group.hpp>
...
struct Dunavant_data<6>
{
	static constexpr auto groups =
		std::make_tuple(Dunavant_points_group{.116786275726379, .501426509658179, .249286745170910},
						...
						Dunavant_points_group{.082851075618374, .053145049844817, .310352451033784,
											  .636502499121399});
};
...
struct Dunavant_data<7>
{
	static constexpr auto groups =
		std::make_tuple(Dunavant_points_group{-.149570044467682, 1. / 3},
						...
						Dunavant_points_group{.077113760890257, .048690315425316, .312865496004874,
											  .638444188569810});
};
