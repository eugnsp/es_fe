...
// 			<< "-------------------------------------------------------" << std::endl;
 ...
 // 					}
 	...
 	//		}
			...
			if (iteration > 10 && residual_norm > residual_norm_old * (1 - armijoConstant * reduction_factor))
			{
				reduction_factor /= 2;
				step_ /= 2;
				solution_.view(0, step_.size(), 0, 1) += step_;
 				...
 				std::cout << std::setprecision(3) << std::scientific
 					<< std::setw(3) << iteration + 1 << std::setw(16) << residual_norm << std::setw(32) << reduction_factor << std::endl;
			...
			const double step_norm = norm2(step_);
 			...
 			std::cout << std::setprecision(3) << std::scientific
 				<< std::setw(3) << iteration + 1 << std::setw(16) << residual_norm << std::setw(16) << step_norm << std::endl;
...
//
//					LOG(LogLevel::INFO, "%4u                %11.3e         %11.3e", numberOfIterations + 1, residualNorm, linearStepSupNorm);
//
...
//			// 		if (hasVariable("phi")) mo.PutScalarDataOnNodes("phi", GetSolutionView("phi"), Energy::eV(1));
//			// 		if (hasVariable("fermi")) mo.PutScalarDataOnNodes("fermi", GetSolutionView("fermi"), Energy::eV(1));
//			// 		if (hasVariable("n")) mo.PutScalarDataOnNodes("n", GetSolutionView("n"), Concentration::ONE_OVER_cm3(1));
//			// 	}
//			// 	#endif
//			// 
...
//				// 		{
//				// 			MATFile m("j.mat");
//				// 			m.write("J", dynamic_cast<Math::LA::CSRSparseMatrix<double>&>(*jacobian));
//				// 		}
//				// 		#endif
//				// 
//				// 		// Jacobian check
...
//
//				// Armijo line-search
//				// 		if (numberOfIterations > 0 && residualNorm > residualNormOld * (1 - armijoConstant * reductionFactor))
//				// 		{
...
//				// 
//				// 			++lineSearchIter;
//				// 			LOG_INFO(" * %3u   %6.4f     %11.3e", lineSearchIter, reductionFactor, residualNorm);
//				// 
//				// 			continue;
//				// 		}
//				// 
...
//
//				LOG(LogLevel::INFO, "%4u                %11.3e         %11.3e", numberOfIterations_ + 1, residualNorm, linearStepSupNorm);
//
...
//				// 
//				// 			//{
//				// 			//	FeMATFileOutput<Math::mesh::Mesh2> mo("system.mat", mesh, Length::nm(1));
//				// 			//	mo.PutScalarDataOnNodes("phi", GetSolutionView("phi"));
//				// 			//	//mo.PutScalarDataOnNodes("psi", GetSolutionView("psi"), Energy::eV(1));
//				// 			//	//mo.PutScalarDataOnNodes("fermi", GetSolutionView("psi") - GetSolutionView("phi"), Energy::eV(1));
//				// 			//	//mo.PutScalarDataOnNodes("fermi", GetSolutionView("fermi"), Energy::eV(1));
//				// 			//	if (HasVariable("n")) mo.PutScalarDataOnNodes("n", GetSolutionView("n"));
//				// 			//	if (HasVariable("F")) mo.PutScalarDataOnNodes("F", GetSolutionView("F"));
//				// 			//	//mo.GetMATFile().PutVar("J", dynamic_cast<CSRSparseMatrix<double>&>(*jacobian));
//				// 
//				// 			//	solution.zero();
//				// 			//	solution.GetView(residual.GetSize()) = residual;
//				// 
//				// 			//	mo.PutScalarDataOnNodes("r_phi", GetSolutionView("phi"));
//				// 			//	//mo.PutScalarDataOnNodes("r_psi", GetSolutionView("psi"), Energy::eV(1));
//				// 			//	if (HasVariable("n")) mo.PutScalarDataOnNodes("r_n", GetSolutionView("n"));
//				// 
//				// 			//	solution.zero();
//				// 			//	solution.GetView(linearStep.GetSize()) = linearStep;
//				// 
//				// 			//	mo.PutScalarDataOnNodes("d_phi", GetSolutionView("phi"));
//				// 			//	//mo.PutScalarDataOnNodes("d_psi", GetSolutionView("psi"), Energy::eV(1));
//				// 			//	//mo.PutScalarDataOnNodes("d_fermi", GetSolutionView("psi") - GetSolutionView("phi"), Energy::eV(1));
//				// 			//	//mo.PutScalarDataOnNodes("d_fermi", GetSolutionView("fermi"), Energy::eV(1));
//				// 			//	if (HasVariable("n")) mo.PutScalarDataOnNodes("d_n", GetSolutionView("n"));
//				// 			//	if (HasVariable("F")) mo.PutScalarDataOnNodes("d_F", GetSolutionView("F"));
//				// 			//}
//				// 
//				// 			//solution = temp;
//				// 
//				// 			//std::cout << solution[dofMap.GetDOFIndex(827, 0)] << ' ' << solution[dofMap.GetDOFIndex(827, 1)] << '\n';
//				// 			//std::cout << solution[dofMap.GetDOFIndex(776, 0)] << ' ' << solution[dofMap.GetDOFIndex(776, 1)] << '\n' << "----------------\n";
//				// 			//std::cout << residual[dofMap.GetDOFIndex(827, 0)] << ' ' << residual[dofMap.GetDOFIndex(827, 1)] << '\n';
//				// 			//std::cout << residual[dofMap.GetDOFIndex(776, 0)] << ' ' << residual[dofMap.GetDOFIndex(776, 1)] << '\n';
//				// 		}
//				// 		#endif
//				// 
...
//				// 		//		AssembleResidualAndJacobian();
//				// 		//		std::cout << residual[dofMap.GetDOFIndex(827, 0)] << " | " << residual[dofMap.GetDOFIndex(827, 1)] << " | " <<
//				// 		//				     residual[dofMap.GetDOFIndex(776, 0)] << " | " << residual[dofMap.GetDOFIndex(776, 1)] << '\n';
//				// 		//	}
//				// 		//}
//				// 
//				// 		if (numberOfVariables() == 2)
...
//		 				LOG_INFO("(%4u, %4u)     %11.3e     %11.3e     %9.1e", row, col, dr[row], jc[row],
//		 					std::abs(dr[row] - jc[row]) / std::max(std::abs(dr[row]), std::abs(jc[row])));
//		 
