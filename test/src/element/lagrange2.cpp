...
void ndofs_test()
{
	...
	static_assert(Element::n_dofs(es_fe::Vertex_tag{}) == vertex_dofs);
	static_assert(Element::n_dofs(es_fe::Edge_tag{}) == edge_dofs);
	static_assert(Element::n_dofs(es_fe::Face_tag{}) == face_dofs);
	static_assert(Element::n_dofs(es_fe::Cell_tag{}) == face_dofs);

	static_assert(Element::n_total_dofs(es_fe::Edge_tag{}) == total_edge_dofs);
	static_assert(Element::n_total_dofs(es_fe::Face_tag{}) == total_face_dofs);
	static_assert(Element::n_total_dofs(es_fe::Cell_tag{}) == total_face_dofs);
	...
	static_assert(Element::has_dofs(es_fe::Vertex_tag{}) == (vertex_dofs > 0));
	static_assert(Element::has_dofs(es_fe::Edge_tag{}) == (edge_dofs > 0));
	static_assert(Element::has_dofs(es_fe::Face_tag{}) == (face_dofs > 0));
	static_assert(Element::has_dofs(es_fe::Cell_tag{}) == (face_dofs > 0));
...
void basis_2_test()
{
	using Element = es_fe::Lagrange<2, 2>;
...
void basis_3_test()
{
	using Element = es_fe::Lagrange<3, 2>;
...
int main()
{
	ndofs_test<es_fe::Lagrange<1, 2>, 1, 0, 0, 2, 3>();
	ndofs_test<es_fe::Lagrange<2, 2>, 1, 1, 0, 3, 6>();
	ndofs_test<es_fe::Lagrange<3, 2>, 1, 2, 1, 4, 10>();
	ndofs_test<es_fe::Lagrange<4, 2>, 1, 3, 3, 5, 15>();

	basis_test<es_fe::Lagrange<1, 2>>();
	basis_test<es_fe::Lagrange<2, 2>>();
	basis_test<es_fe::Lagrange<3, 2>>();
	basis_test<es_fe::Lagrange<4, 2>>();
